<script type="text/javascript">
    ...
    $(document).ready(function(){
        reset_select();
        $('#id_desa_cari,#tahun_cari,#id_kecamatan,#id_desa').select2();
        $('#id_desa').select2({
        ...
        table = $('#datable_1').DataTable({
            ...
            columns: [
                ...
                {"data": "kecamatan","orderable": false},
    ...
    function reset_select(){
       $('#nama,#id_desa_cari,#id_kecamatan,#id_desa').val('').trigger('change');
    }
